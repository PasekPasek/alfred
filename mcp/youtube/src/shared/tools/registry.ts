...
import { findChannelTool } from './find-channel.js';
import { getPlaylistTool } from './get-playlist.js';
import { scanChannelTool } from './scan-channel.js';
import { searchVideosTool } from './search-videos.js';
import { videoDetailsTool } from './video-details.js';
...
export const sharedTools: RegisteredTool[] = [
  asRegisteredTool(findChannelTool),
  asRegisteredTool(scanChannelTool),
  asRegisteredTool(searchVideosTool),
  asRegisteredTool(getPlaylistTool),
  asRegisteredTool(videoDetailsTool),
];
