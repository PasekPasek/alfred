...
const scrapeFormats = z.enum(['markdown', 'links', 'screenshot']);
...
export const scrapeInputSchema = z
  .object({
    ...
    formats: z
      ...
      .optional()
      .default(['markdown'])
      .describe('Output formats: markdown (default), links, screenshot'),
    onlyMainContent: z
      .boolean()
      .optional()
      .default(true)
...
Features:
- Output formats: markdown (default), links, screenshot
